...
const formatDateTime = (datetime) => {
  ...
  const options = { weekday: 'long', hour: '2-digit', timeZone: 'UTC'};
      ...
      <View className="flex-row items-center gap-3">
        <View className="justify-center items-center flex-row flex-1">
          ...
          <View className="justify-center flex-1 ml-3 gap-y-1">
            ...
            <Text className="text-base text-white font-pregular" numberOfLines={1}>${price}  ⚽Game  {maxparticipants/2} vs {maxparticipants/2}</Text>
          </View>
        </View>
        <View className="pt-2">
